...
export function HowItWorks() {
  const steps = [
    ...
    },
    {
      ...
      description: "Personnalisez votre agenda, ajoutez vos informations de cabinet et importez vos patients existants.",
      time: "5 min",
      bgColor: "bg-green-50",
    ...
    },
    {
      ...
      title: "Prêt à l'utilisation",
      description: "Commencez immédiatement à programmer vos rendez-vous, suivre vos patients et générer vos factures.",
      time: "Immédiat",
          ...
          <div className="inline-flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 bg-white p-8 rounded-2xl shadow-lg">
            <div className="text-center sm:text-left">
              ...
              <p className="text-gray-600">
                Rejoignez plus de 10 cabinets qui nous font confiance
              </p>
            </div>
